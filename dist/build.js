"bundle";
System.register("src/peerBinary.js", ["npm:babel-runtime@5.8.38/helpers/get.js", "npm:babel-runtime@5.8.38/helpers/inherits.js", "npm:babel-runtime@5.8.38/helpers/create-class.js", "npm:babel-runtime@5.8.38/helpers/class-call-check.js", "github:feross/simple-peer@6.0.4/simplepeer.min.js", "src/dataUtils.js", "github:agektmr/binarize.js@master/src/binarize.js"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, Peer2, generateWebRTCpayload, binarize, Peer, PeerBinary, UnChunker;
  ...
  return {
    ...
    }, function (_githubFerossSimplePeer604SimplepeerMinJs) {
      Peer2 = _githubFerossSimplePeer604SimplepeerMinJs;
    }, function (_srcDataUtilsJs) {
      generateWebRTCpayload = _srcDataUtilsJs.generateWebRTCpayload;
    }, function (_githubAgektmrBinarizeJsMasterSrcBinarizeJs) {
      binarize = _githubAgektmrBinarizeJsMasterSrcBinarizeJs;
    }],
    execute: function () {
      "use strict";
      ...
      PeerBinary = (function (_Peer) {
        ...
        function PeerBinary(options) {
          ...
          _get(Object.getPrototypeOf(PeerBinary.prototype), "constructor", this).call(this, options);
          this._registerDataMessage();
          this.unchunker = new UnChunker(); //
          this.unchunker.onData = function (val) {
      ...
      _export("UnChunker", UnChunker);
    }
  };
});
System.register("src/P2PServer.js", ["npm:babel-runtime@5.8.38/helpers/create-class.js", "npm:babel-runtime@5.8.38/helpers/class-call-check.js", "npm:babel-runtime@5.8.38/helpers/get.js", "npm:babel-runtime@5.8.38/helpers/inherits.js", "npm:babel-runtime@5.8.38/core-js/object/assign.js", "npm:babel-runtime@5.8.38/core-js/get-iterator.js", "src/PeerBinary.js", "github:firebase/firebase-bower@2.4.2.js", "src/settings.js", "src/Evented.js"], function (_export) {
  var _createClass, _classCallCheck, _get, _inherits, _Object$assign, _getIterator, PeerBinary, settings, Evented, Channel, P2PServer;
  ...
  return {
    ...
    }, function (_srcPeerBinaryJs) {
      PeerBinary = _srcPeerBinaryJs.PeerBinary;
    }, function (_githubFirebaseFirebaseBower242Js) {}, function (_srcSettingsJs) {
      settings = _srcSettingsJs.settings;
    }, function (_srcEventedJs) {
      Evented = _srcEventedJs.Evented;
    }],
    execute: function () {
      "use strict";
      ...
      P2PServer = (function (_Evented) {
        ...
        function P2PServer() {
          ...
          _get(Object.getPrototypeOf(P2PServer.prototype), "constructor", this).call(this); //no idea what this does
          this.MAX_CONNECTIONS = 20;
          this.debug = false;
          this.id = "server" + Math.floor(Math.random() * 100000);
          this.firebaseURL = settings.firebaseURL;
          _Object$assign(this, options); //_.extendOwn(this, options)
        ...
        _createClass(P2PServer, [{
          ...
          value: function init() {
            ...
            this._intervalID = setInterval(function () {
              _this.updateRef.set(new Date().getTime());
          ...
          value: function sendToAll(data) {
            ...
            try {
              for (var _iterator = _getIterator(this.connections), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          value: function listenToChannels() {
            ...
            this.channelRef.on('child_added', function (ev, prevKey) {
              if (_this2.connections.length > _this2.MAX_CONNECTIONS) {
              ...
              for (var i in val.fromClient) {
                ...
                if (sig.type == 'offer') {
                  var channel = new Channel(_this2.channelRef.child(ev.key()), _this2._makePeer());
                  _this2.connections.push(channel);
                  ...
                  channel.inRef.on('child_added', function (ev2) {
                    var val2 = ev2.val();
                    if (val2.candidate) {
                      if (_this2.debug) console.log('server got candidate from firebase', val2);
          ...
          value: function _makePeer() {
            ...
            p.on('error', function (err) {
              ...
              _this3.fire('error', { peer: p, err: err });
            });
            p.on('connect', function () {
              if (_this3.debug) console.log('server: client connected');
              _this3.fire('connect', { peer: p });
            });
            p.on('data', function (data) {
              if (_this3.debug) console.log('server: server recieved some data: ', data);
              _this3.fire('data', { peer: p, data: data });
            });
            p.on('close', function () {
              if (_this3.debug) console.log('server: connection closed', p);
              _this3._removeConnection(p);
              _this3.fire('close', { peer: p });
            });
            p.on('dataBig', function (data) {
              _this3.fire('dataBig', { peer: p, data: data });
            });
          ...
          value: function destroy() {
            ...
            try {
              for (var _iterator2 = _getIterator(this.connections), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var x = _step2.value;
...
(function(e) {
  if (typeof exports === "object" && typeof module !== "undefined") {
    ...
    define("github:feross/simple-peer@6.0.4/simplepeer.min.js", [], e);
  } else {
    var t;
...
System.register("src/dataUtils.js", ["github:agektmr/binarize.js@master/src/binarize.js", "src/Evented.js", "src/settings.js"], function (_export) {
  ...
  var binarize, Evented, settings, drawingCanvas;

  _export("generateWebRTCpayload", generateWebRTCpayload);

  _export("arrayBufferToChunks", arrayBufferToChunks);
  ...
  return {
    setters: [function (_githubAgektmrBinarizeJsMasterSrcBinarizeJs) {
      binarize = _githubAgektmrBinarizeJsMasterSrcBinarizeJs;
    }, function (_srcEventedJs) {
      Evented = _srcEventedJs.Evented;
    }, function (_srcSettingsJs) {
      settings = _srcSettingsJs.settings;
    }],
    execute: function () {
...
System.registerDynamic("github:agektmr/binarize.js@master/src/binarize.js", [], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("github:firebase/firebase-bower@2.4.2/firebase.js", [], false, function($__require, $__exports, $__module) {
...
System.registerDynamic("github:firebase/firebase-bower@2.4.2.js", ["github:firebase/firebase-bower@2.4.2/firebase.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  module.exports = $__require('github:firebase/firebase-bower@2.4.2/firebase.js');
  return module.exports;
});

System.register("src/settings.js", [], function (_export) {
  "use strict";
...
System.register("src/Evented.js", ["npm:babel-runtime@5.8.38/helpers/create-class.js", "npm:babel-runtime@5.8.38/helpers/class-call-check.js", "npm:babel-runtime@5.8.38/core-js/get-iterator.js"], function (_export) {
  var _createClass, _classCallCheck, _getIterator, Evented;
  ...
  return {
    ...
    execute: function () {
        ...
        _createClass(Evented, [{
          ...
          value: function fire(eventName, argument) {
            ...
            if (this.events[eventName]) {
              ...
              try {
                for (var _iterator = _getIterator(this.events[eventName]), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  var cb = _step.value;
      ...
      _export("Evented", Evented);
    }
  };
});
System.register("src/P2PClient.js", ["npm:babel-runtime@5.8.38/helpers/get.js", "npm:babel-runtime@5.8.38/helpers/inherits.js", "npm:babel-runtime@5.8.38/helpers/create-class.js", "npm:babel-runtime@5.8.38/helpers/class-call-check.js", "npm:babel-runtime@5.8.38/core-js/object/assign.js", "src/PeerBinary.js", "github:firebase/firebase-bower@2.4.2.js", "src/settings.js", "src/Evented.js"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, _Object$assign, PeerBinary, settings, Evented, P2PClient;
    ...
    execute: function () {
      ...
      P2PClient = (function (_Evented) {
        ...
        function P2PClient() {
          ...
          _get(Object.getPrototypeOf(P2PClient.prototype), "constructor", this).call(this);
          _Object$assign(this, settings); //_.extend(this,settings)
          _Object$assign(this, options); //_.extend(this,options)
        ...
        _createClass(P2PClient, [{
          ...
          value: function connectToPeerID(id) {
            ...
            this.getPeerList(function () {
              var peer = _this2.peerList[id];
              if (!peer) {
                console.error('peer not defined. id:', id);
                callback("peer not defined");
              } else {
                _this2.serverRef = _this2.fbref.child(id);
                var p = new PeerBinary({ initiator: true, trickle: true, iceServers: _this2.ICE_SERVERS });
                _this2.connection = p;
                _this2._registerEvents();
                p.on('signal', function (data) {
                  if (data.type == "offer") {
                    _this2._createChannel(data);
                  } else if (data.candidate) {
                    if (_this2.debug) console.log('client recieved candidate from webrtc', data);
                    _this2.outRef.push(data);
                  } else {
                    console.warn('Client recieved unexpected signal through WebRTC:', data);
                  }
                });
                callback(null, _this2.connection);
              }
            });
          }
        }, {
          ...
          value: function _createChannel(offer) {
            ...
            this.inRef.on('child_added', function (ev) {
              if (_this3.debug) console.log('channel message, client', ev.val());
              var val = ev.val();
              if (val.type == 'answer') {
                setTimeout(function () {
                  _this3.connection.signal(val);
                }, 1); // a slight delay helps establish connection, I think.
              } else if (val.candidate) {
                  if (_this3.debug) console.log('client recieved candidate from firebase');
                  setTimeout(function () {
                    _this3.connection.signal(val);
                  }, 1);
                } else {
          ...
          value: function _registerEvents() {
            ...
            this.connection.on('error', function (err) {
              ...
              _this4.fire('error', { peer: _this4.connection, err: err });
            });
            this.connection.on('connect', function () {
              if (_this4.debug) console.log('client: client connected');
              _this4.fire('connect', { peer: _this4.connection });
            });
            this.connection.on('data', function (data) {
              if (_this4.debug) console.log('server: server recieved some data: ', data);
              _this4.fire('data', { peer: _this4.connection, data: data });
            });
            this.connection.on('close', function (data) {
              if (_this4.debug) console.log('connection closed', _this4.connection);
              _this4.fire('close', { peer: _this4.connection });
            });
            this.connection.on('dataBig', function (data) {
              _this4.fire('dataBig', { peer: _this4.connection, data: data });
            });
          }
        }]);
...
System.register("tests/testDataUtils.js", ["src/dataUtils.js", "src/peerBinary.js", "src/P2PServer.js", "src/P2PClient.js"], function (_export) {
  "use strict";

  var dtls, pb, P2PServer, P2PClient, testIfItGetsFragmented;
  ...
  function testDisconnect() {
    ...
    //
    client4disconnect.connectToPeerID(id, function (err, connection) {
      if (err) {
  ...
  return {
    setters: [function (_srcDataUtilsJs) {
      dtls = _srcDataUtilsJs;
    }, function (_srcPeerBinaryJs) {
      pb = _srcPeerBinaryJs;
    }, function (_srcP2PServerJs) {
      P2PServer = _srcP2PServerJs.P2PServer;
    }, function (_srcP2PClientJs) {
      P2PClient = _srcP2PClientJs.P2PClient;
    }],
    execute: function () {
      testIfItGetsFragmented = function testIfItGetsFragmented() {
